import { getArticleLink, cn } from '@/lib/utils'
...
const ArticleCardMedium: React.FC<ArticleCardMediumProps> = ({
	article,
	className,
}) => {
	return (
		<a
			...
			className={cn(
				'block group p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300',
				className
			)}
		>
